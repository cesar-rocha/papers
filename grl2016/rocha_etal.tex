...
\titlerunninghead{Seasonal modulation of ocean dynamics}
...
\title{Seasonal eddy variability in Kuroshio Extension}
%
...
\authors{Cesar, Sarah, \& Teri\altaffilmark{1}}
...
\keypoints{\item Surface velocity presents significant seasonal cycle at submesoscales.
           \item Submesoscale vorticity and strain peaks in late Winter/early Fall.
           \item Diagnosing this seasonal cycle from SSH snapshots is precluded by the presence
                 strong high-frequency ageostrophic flows.}
